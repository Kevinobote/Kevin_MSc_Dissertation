% Template for Strathmore  Masters Research Project
%
...
\title{A Novel Kiswahili Audio Processing Pipeline: An Integrated Approach to Speech Recognition, Sentiment Analysis, and Text Summarization.}
% Your name must be in English Capitalisation with no comma, 
% and the Family name comes last.
\author{Obote  Kevin Omondi (kevin.obote@strathmore.edu)\\
...
\large Strathmore University\\
\\
% Example1
{\small Supervised by: Dr. Betsy Muriithi}\\
...
\date{{\small 13 January 2026}
\vspace{0.5cm}
 \\ {\scriptsize\it A dissertation Submitted in Partial Fulfillment of The Requirements for The Degree of Master of Science in Data Science and Analytics, \\ @iLabAfrica, Strathmore University}\\%
  \vspace{0.5cm}{\includegraphics{images/36.png}}}
%-------------------------------------------------------------------------
\begin{document}
...
%-----------------------------------------------------------------------------
%-----------------------------------------------------------------------------
% APPENDICES (formal, unnumbered)
%-----------------------------------------------------------------------------
% In main.tex, before including appendix
%-----------------------------------------------------------------------------
% APPENDICES (formal, unnumbered, TOC-clean)
%-----------------------------------------------------------------------------
\clearpage

% Disable ALL numbering below this point
